...
class DevicesUnmanagedListRequestDeviceTypesItem(str, enum.Enum):
    ...
    def visit(
        ...
        if self is DevicesUnmanagedListRequestDeviceTypesItem.AKUVOX_LOCK:
            return akuvox_lock()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.AUGUST_LOCK:
            return august_lock()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.BRIVO_ACCESS_POINT:
            return brivo_access_point()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.BUTTERFLYMX_PANEL:
            return butterflymx_panel()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.DOORKING_LOCK:
            return doorking_lock()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.GENIE_DOOR:
            return genie_door()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.IGLOO_LOCK:
            return igloo_lock()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.LINEAR_LOCK:
            return linear_lock()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.LOCKLY_LOCK:
            return lockly_lock()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.KWIKSET_LOCK:
            return kwikset_lock()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.NUKI_LOCK:
            return nuki_lock()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.SALTO_LOCK:
            return salto_lock()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.SCHLAGE_LOCK:
            return schlage_lock()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.SEAM_RELAY:
            return seam_relay()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.SMARTTHINGS_LOCK:
            return smartthings_lock()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.YALE_LOCK:
            return yale_lock()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.TWO_N_INTERCOM:
            return two_n_intercom()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.CONTROLBYWEB_DEVICE:
            return controlbyweb_device()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.TTLOCK_LOCK:
            return ttlock_lock()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.IGLOOHOME_LOCK:
            return igloohome_lock()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.HUBITAT_LOCK:
            return hubitat_lock()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.NOISEAWARE_ACTIVITY_ZONE:
            return noiseaware_activity_zone()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.MINUT_SENSOR:
            return minut_sensor()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.ECOBEE_THERMOSTAT:
            return ecobee_thermostat()
        if self is DevicesUnmanagedListRequestDeviceTypesItem.NEST_THERMOSTAT:
