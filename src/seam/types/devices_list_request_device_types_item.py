...
class DevicesListRequestDeviceTypesItem(str, enum.Enum):
    ...
    def visit(
        ...
        if self is DevicesListRequestDeviceTypesItem.AKUVOX_LOCK:
            return akuvox_lock()
        if self is DevicesListRequestDeviceTypesItem.AUGUST_LOCK:
            return august_lock()
        if self is DevicesListRequestDeviceTypesItem.BRIVO_ACCESS_POINT:
            return brivo_access_point()
        if self is DevicesListRequestDeviceTypesItem.BUTTERFLYMX_PANEL:
            return butterflymx_panel()
        if self is DevicesListRequestDeviceTypesItem.DOORKING_LOCK:
            return doorking_lock()
        if self is DevicesListRequestDeviceTypesItem.GENIE_DOOR:
            return genie_door()
        if self is DevicesListRequestDeviceTypesItem.IGLOO_LOCK:
            return igloo_lock()
        if self is DevicesListRequestDeviceTypesItem.LINEAR_LOCK:
            return linear_lock()
        if self is DevicesListRequestDeviceTypesItem.LOCKLY_LOCK:
            return lockly_lock()
        if self is DevicesListRequestDeviceTypesItem.KWIKSET_LOCK:
            return kwikset_lock()
        if self is DevicesListRequestDeviceTypesItem.NUKI_LOCK:
            return nuki_lock()
        if self is DevicesListRequestDeviceTypesItem.SALTO_LOCK:
            return salto_lock()
        if self is DevicesListRequestDeviceTypesItem.SCHLAGE_LOCK:
            return schlage_lock()
        if self is DevicesListRequestDeviceTypesItem.SEAM_RELAY:
            return seam_relay()
        if self is DevicesListRequestDeviceTypesItem.SMARTTHINGS_LOCK:
            return smartthings_lock()
        if self is DevicesListRequestDeviceTypesItem.YALE_LOCK:
            return yale_lock()
        if self is DevicesListRequestDeviceTypesItem.TWO_N_INTERCOM:
            return two_n_intercom()
        if self is DevicesListRequestDeviceTypesItem.CONTROLBYWEB_DEVICE:
            return controlbyweb_device()
        if self is DevicesListRequestDeviceTypesItem.TTLOCK_LOCK:
            return ttlock_lock()
        if self is DevicesListRequestDeviceTypesItem.IGLOOHOME_LOCK:
            return igloohome_lock()
        if self is DevicesListRequestDeviceTypesItem.HUBITAT_LOCK:
            return hubitat_lock()
        if self is DevicesListRequestDeviceTypesItem.NOISEAWARE_ACTIVITY_ZONE:
            return noiseaware_activity_zone()
        if self is DevicesListRequestDeviceTypesItem.MINUT_SENSOR:
            return minut_sensor()
        if self is DevicesListRequestDeviceTypesItem.ECOBEE_THERMOSTAT:
            return ecobee_thermostat()
        if self is DevicesListRequestDeviceTypesItem.NEST_THERMOSTAT:
