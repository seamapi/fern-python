...
class ConnectWebviewsClient:
    ...
    def create(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._environment.value}/", "connect_webviews/create"),
    ...
    def delete(self, *, connect_webview_id: str) -> ConnectWebviewsDeleteResponse:
        ...
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._environment.value}/", "connect_webviews/delete"),
    ...
    def get(self, *, connect_webview_id: str) -> ConnectWebviewsGetResponse:
        ...
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._environment.value}/", "connect_webviews/get"),
            json=jsonable_encoder({"connect_webview_id": connect_webview_id}),
            headers=self._client_wrapper.get_headers(),
            timeout=60,
        )
    ...
    def list(self) -> ConnectWebviewsListResponse:
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._environment.value}/", "connect_webviews/list"),
            headers=self._client_wrapper.get_headers(),
            timeout=60,
        )
        if 200 <= _response.status_code < 300:
    ...
    def view(self, *, connect_webview_id: str, auth_token: str) -> None:
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._environment.value}/", "connect_webviews/view"),
