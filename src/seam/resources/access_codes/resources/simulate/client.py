...
from .....types.access_codes_simulate_create_unmanaged_access_code_response import (
...
class SimulateClient:
    ...
    def create_unmanaged_access_code(
        ...
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._environment.value}/", "access_codes/simulate/create_unmanaged_access_code"),
            json=jsonable_encoder({"device_id": device_id, "name": name, "code": code}),
            headers=self._client_wrapper.get_headers(),
            timeout=60,
        )
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(AccessCodesSimulateCreateUnmanagedAccessCodeResponse, _response.json())  # type: ignore
