...
class LocksListRequestDeviceTypesItem(str, enum.Enum):
    ...
    def visit(
        ...
        if self is LocksListRequestDeviceTypesItem.AKUVOX_LOCK:
            return akuvox_lock()
        if self is LocksListRequestDeviceTypesItem.AUGUST_LOCK:
            return august_lock()
        if self is LocksListRequestDeviceTypesItem.BRIVO_ACCESS_POINT:
            return brivo_access_point()
        if self is LocksListRequestDeviceTypesItem.BUTTERFLYMX_PANEL:
            return butterflymx_panel()
        if self is LocksListRequestDeviceTypesItem.DOORKING_LOCK:
            return doorking_lock()
        if self is LocksListRequestDeviceTypesItem.GENIE_DOOR:
            return genie_door()
        if self is LocksListRequestDeviceTypesItem.IGLOO_LOCK:
            return igloo_lock()
        if self is LocksListRequestDeviceTypesItem.LINEAR_LOCK:
            return linear_lock()
        if self is LocksListRequestDeviceTypesItem.LOCKLY_LOCK:
            return lockly_lock()
        if self is LocksListRequestDeviceTypesItem.KWIKSET_LOCK:
            return kwikset_lock()
        if self is LocksListRequestDeviceTypesItem.NUKI_LOCK:
            return nuki_lock()
        if self is LocksListRequestDeviceTypesItem.SALTO_LOCK:
            return salto_lock()
        if self is LocksListRequestDeviceTypesItem.SCHLAGE_LOCK:
            return schlage_lock()
        if self is LocksListRequestDeviceTypesItem.SEAM_RELAY:
            return seam_relay()
        if self is LocksListRequestDeviceTypesItem.SMARTTHINGS_LOCK:
            return smartthings_lock()
        if self is LocksListRequestDeviceTypesItem.YALE_LOCK:
            return yale_lock()
        if self is LocksListRequestDeviceTypesItem.TWO_N_INTERCOM:
            return two_n_intercom()
        if self is LocksListRequestDeviceTypesItem.CONTROLBYWEB_DEVICE:
            return controlbyweb_device()
        if self is LocksListRequestDeviceTypesItem.TTLOCK_LOCK:
            return ttlock_lock()
        if self is LocksListRequestDeviceTypesItem.IGLOOHOME_LOCK:
            return igloohome_lock()
        if self is LocksListRequestDeviceTypesItem.HUBITAT_LOCK:
            return hubitat_lock()
        if self is LocksListRequestDeviceTypesItem.NOISEAWARE_ACTIVITY_ZONE:
            return noiseaware_activity_zone()
        if self is LocksListRequestDeviceTypesItem.MINUT_SENSOR:
            return minut_sensor()
        if self is LocksListRequestDeviceTypesItem.ECOBEE_THERMOSTAT:
            return ecobee_thermostat()
        if self is LocksListRequestDeviceTypesItem.NEST_THERMOSTAT:
