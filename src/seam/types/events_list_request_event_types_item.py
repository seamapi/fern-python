...
class EventsListRequestEventTypesItem(str, enum.Enum):
    ...
    def visit(
        ...
        if self is EventsListRequestEventTypesItem.DEVICE_CONNECTED:
            return device_connected()
        if self is EventsListRequestEventTypesItem.DEVICE_UNMANAGED_CONNECTED:
            return device_unmanaged_connected()
        if self is EventsListRequestEventTypesItem.DEVICE_DISCONNECTED:
            return device_disconnected()
        if self is EventsListRequestEventTypesItem.DEVICE_UNMANAGED_DISCONNECTED:
            return device_unmanaged_disconnected()
        if self is EventsListRequestEventTypesItem.DEVICE_CONVERTED_TO_UNMANAGED:
            return device_converted_to_unmanaged()
        if self is EventsListRequestEventTypesItem.DEVICE_UNMANAGED_CONVERTED_TO_MANAGED:
            return device_unmanaged_converted_to_managed()
        if self is EventsListRequestEventTypesItem.DEVICE_REMOVED:
            return device_removed()
        if self is EventsListRequestEventTypesItem.DEVICE_TAMPERED:
            return device_tampered()
        if self is EventsListRequestEventTypesItem.DEVICE_LOW_BATTERY:
            return device_low_battery()
        if self is EventsListRequestEventTypesItem.DEVICE_BATTERY_STATUS_CHANGED:
            return device_battery_status_changed()
        if self is EventsListRequestEventTypesItem.ACCESS_CODE_CREATED:
            return access_code_created()
        if self is EventsListRequestEventTypesItem.ACCESS_CODE_CHANGED:
            return access_code_changed()
        if self is EventsListRequestEventTypesItem.ACCESS_CODE_SCHEDULED_ON_DEVICE:
            return access_code_scheduled_on_device()
        if self is EventsListRequestEventTypesItem.ACCESS_CODE_SET_ON_DEVICE:
            return access_code_set_on_device()
        if self is EventsListRequestEventTypesItem.ACCESS_CODE_DELETED:
            return access_code_deleted()
        if self is EventsListRequestEventTypesItem.ACCESS_CODE_REMOVED_FROM_DEVICE:
            return access_code_removed_from_device()
        if self is EventsListRequestEventTypesItem.ACCESS_CODE_FAILED_TO_SET_ON_DEVICE:
            return access_code_failed_to_set_on_device()
        if self is EventsListRequestEventTypesItem.ACCESS_CODE_DELAY_IN_SETTING_ON_DEVICE:
            return access_code_delay_in_setting_on_device()
        if self is EventsListRequestEventTypesItem.ACCESS_CODE_FAILED_TO_REMOVE_FROM_DEVICE:
            return access_code_failed_to_remove_from_device()
        if self is EventsListRequestEventTypesItem.ACCESS_CODE_DELAY_IN_REMOVING_FROM_DEVICE:
            return access_code_delay_in_removing_from_device()
        if self is EventsListRequestEventTypesItem.ACCESS_CODE_UNMANAGED_CONVERTED_TO_MANAGED:
            return access_code_unmanaged_converted_to_managed()
        if self is EventsListRequestEventTypesItem.ACCESS_CODE_UNMANAGED_FAILED_TO_CONVERT_TO_MANAGED:
            return access_code_unmanaged_failed_to_convert_to_managed()
        if self is EventsListRequestEventTypesItem.ACCESS_CODE_UNMANAGED_CREATED:
            return access_code_unmanaged_created()
        if self is EventsListRequestEventTypesItem.ACCESS_CODE_UNMANAGED_REMOVED:
            return access_code_unmanaged_removed()
        if self is EventsListRequestEventTypesItem.LOCK_LOCKED:
            return lock_locked()
        if self is EventsListRequestEventTypesItem.LOCK_UNLOCKED:
            return lock_unlocked()
        if self is EventsListRequestEventTypesItem.CONNECTED_ACCOUNT_CONNECTED:
            return connected_account_connected()
        if self is EventsListRequestEventTypesItem.CONNECTED_ACCOUNT_CREATED:
            return connected_account_created()
        if self is EventsListRequestEventTypesItem.CONNECTED_ACCOUNT_DISCONNECTED:
            return connected_account_disconnected()
        if self is EventsListRequestEventTypesItem.CONNECTED_ACCOUNT_COMPLETED_FIRST_SYNC:
            return connected_account_completed_first_sync()
        if self is EventsListRequestEventTypesItem.NOISE_SENSOR_NOISE_THRESHOLD_TRIGGERED:
            return noise_sensor_noise_threshold_triggered()
        if self is EventsListRequestEventTypesItem.ACCESS_CODE_BACKUP_ACCESS_CODE_PULLED:
