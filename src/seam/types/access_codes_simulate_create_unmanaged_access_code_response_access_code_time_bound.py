...
class AccessCodesSimulateCreateUnmanagedAccessCodeResponseAccessCodeTimeBound(pydantic.BaseModel):
    access_code_id: str
    code: typing.Optional[str]
    status: typing_extensions.Literal["set"]
    created_at: AccessCodesSimulateCreateUnmanagedAccessCodeResponseAccessCodeTimeBoundCreatedAt
    is_managed: str
