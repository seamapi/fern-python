...
class DeviceDeviceTypeDeviceDeviceType(str, enum.Enum):
    ...
    def visit(
        ...
        if self is DeviceDeviceTypeDeviceDeviceType.ECOBEE_THERMOSTAT:
            return ecobee_thermostat()
        if self is DeviceDeviceTypeDeviceDeviceType.NEST_THERMOSTAT:
